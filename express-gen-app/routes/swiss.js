...
router.get('/', async function(req, res, next) {
  ...
  var myPath = path.resolve(__dirname, `../public/json/tableLeagueStats_swiss.json`);
  tableLeagueStats.swiss = JSON.parse(fs.readFileSync(myPath, 'utf8'));
  let chartDataLeagueStats = {};
  var myPath = path.resolve(__dirname, '../public/json/chartDataLeagueStats_swiss.json');
  chartDataLeagueStats.swiss = JSON.parse(fs.readFileSync(myPath, 'utf8'));
  res.render(league, {
    config: config,
