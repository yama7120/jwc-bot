...
router.get('/', async function(req, res, next) {
  ...
  var myPath = path.resolve(__dirname, `../public/json/tableLeagueStats_j1.json`);
  tableLeagueStats.j1 = JSON.parse(fs.readFileSync(myPath, 'utf8'));
  let chartDataLeagueStats = {};
  var myPath = path.resolve(__dirname, '../public/json/chartDataLeagueStats_j1.json');
  chartDataLeagueStats.j1 = JSON.parse(fs.readFileSync(myPath, 'utf8'));
  res.render(league, {
    config: config,
