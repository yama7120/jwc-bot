...
router.get('/', async function(req, res, next) {
  ...
  var myPath = path.resolve(__dirname, `../public/json/tableLeagueStats_j2.json`);
  tableLeagueStats.j2 = JSON.parse(fs.readFileSync(myPath, 'utf8'));
  let chartDataLeagueStats = {};
  var myPath = path.resolve(__dirname, '../public/json/chartDataLeagueStats_j2.json');
  chartDataLeagueStats.j2 = JSON.parse(fs.readFileSync(myPath, 'utf8'));
  res.render(league, {
    config: config,
